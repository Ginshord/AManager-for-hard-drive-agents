...
Socket programming--a manager written in Java, manages the agents implemented in c that are responsible for telling manager
abt corresponding hard drives' info like whether hard drives are broken, their info, and etc.
